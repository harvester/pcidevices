...
type NodeClient interface {
	...
	Get(name string, options metav1.GetOptions) (*v1beta1.Node, error)
	List(opts metav1.ListOptions) (*v1beta1.NodeList, error)
...
type NodeCache interface {
	...
	List(selector labels.Selector) ([]*v1beta1.Node, error)
...
func (c *nodeController) Get(name string, options metav1.GetOptions) (*v1beta1.Node, error) {
	result := &v1beta1.Node{}
	return result, c.client.Get(context.TODO(), "", name, result, options)
}

func (c *nodeController) List(opts metav1.ListOptions) (*v1beta1.NodeList, error) {
...
func (c *nodeController) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (*v1beta1.Node, error) {
	result := &v1beta1.Node{}
...
func (c *nodeCache) Get(name string) (*v1beta1.Node, error) {
...
func (c *nodeCache) List(selector labels.Selector) (ret []*v1beta1.Node, err error) {
