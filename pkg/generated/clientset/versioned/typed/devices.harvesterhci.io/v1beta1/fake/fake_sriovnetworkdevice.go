...
func (c *FakeSRIOVNetworkDevices) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.SRIOVNetworkDeviceList, err error) {
	...
	list := &v1beta1.SRIOVNetworkDeviceList{ListMeta: obj.(*v1beta1.SRIOVNetworkDeviceList).ListMeta}
	for _, item := range obj.(*v1beta1.SRIOVNetworkDeviceList).Items {
...
func (c *FakeSRIOVNetworkDevices) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteActionWithOptions(sriovnetworkdevicesResource, name, opts), &v1beta1.SRIOVNetworkDevice{})
	return err
}
