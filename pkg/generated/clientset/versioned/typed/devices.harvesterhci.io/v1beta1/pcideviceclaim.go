...
type pCIDeviceClaims struct {
	*gentype.ClientWithList[*v1beta1.PCIDeviceClaim, *v1beta1.PCIDeviceClaimList]
}
...
func newPCIDeviceClaims(c *DevicesV1beta1Client) *pCIDeviceClaims {
	return &pCIDeviceClaims{
		gentype.NewClientWithList[*v1beta1.PCIDeviceClaim, *v1beta1.PCIDeviceClaimList](
			"pcideviceclaims",
			c.RESTClient(),
			scheme.ParameterCodec,
			"",
			func() *v1beta1.PCIDeviceClaim { return &v1beta1.PCIDeviceClaim{} },
			func() *v1beta1.PCIDeviceClaimList { return &v1beta1.PCIDeviceClaimList{} }),
	}
}
