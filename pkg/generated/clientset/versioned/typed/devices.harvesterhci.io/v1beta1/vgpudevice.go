...
type vGPUDevices struct {
	*gentype.ClientWithList[*v1beta1.VGPUDevice, *v1beta1.VGPUDeviceList]
}

// newVGPUDevices returns a VGPUDevices
func newVGPUDevices(c *DevicesV1beta1Client) *vGPUDevices {
	return &vGPUDevices{
		gentype.NewClientWithList[*v1beta1.VGPUDevice, *v1beta1.VGPUDeviceList](
			"vgpudevices",
			c.RESTClient(),
			scheme.ParameterCodec,
			"",
			func() *v1beta1.VGPUDevice { return &v1beta1.VGPUDevice{} },
			func() *v1beta1.VGPUDeviceList { return &v1beta1.VGPUDeviceList{} }),
	}
}
