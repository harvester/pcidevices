...
import (
	...
	scheme "github.com/harvester/pcidevices/pkg/clientset/versioned/scheme"
...
func (c *pCIDevices) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.PCIDevice, err error) {
...
func (c *pCIDevices) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.PCIDeviceList, err error) {
...
func (c *pCIDevices) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *pCIDevices) Create(ctx context.Context, pCIDevice *v1beta1.PCIDevice, opts v1.CreateOptions) (result *v1beta1.PCIDevice, err error) {
	result = &v1beta1.PCIDevice{}
	err = c.client.Post().
		Resource("pcidevices").
		VersionedParams(&opts, scheme.ParameterCodec).
...
func (c *pCIDevices) Update(ctx context.Context, pCIDevice *v1beta1.PCIDevice, opts v1.UpdateOptions) (result *v1beta1.PCIDevice, err error) {
	result = &v1beta1.PCIDevice{}
	err = c.client.Put().
		Resource("pcidevices").
		Name(pCIDevice.Name).
...
func (c *pCIDevices) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *pCIDevices) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *pCIDevices) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.PCIDevice, err error) {
	result = &v1beta1.PCIDevice{}
