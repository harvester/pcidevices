...
require (
	...
	github.com/rancher/system-upgrade-controller/pkg/apis v0.0.0-20260623211655-532fabb38cc4 // indirect
...
replace (
	...
	github.com/rancher/wrangler => github.com/rancher/wrangler/v3 v3.7.0
