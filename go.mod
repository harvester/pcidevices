...
require (
	...
	github.com/harvester/harvester v1.8.1
...
replace (
	...
	github.com/kube-logging/logging-operator/pkg/sdk/logging/model/syslogng/config => github.com/kube-logging/logging-operator/pkg/sdk/logging/model/syslogng/config v0.12.0
	...
	k8s.io/externaljwt => k8s.io/externaljwt v1.33.7
